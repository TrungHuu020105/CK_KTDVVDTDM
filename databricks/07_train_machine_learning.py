...
DEFAULTS = {
    ...
    "FORECAST_STRATEGY": "recursive_72h",
    "DASHBOARD_HORIZON_HOURS": "72",
...
TARGETS = [
    ("temperature", "temp_target_1"),
    ("humidity", "humidity_target_1"),
]
                ...
                try:
                    ...
                    with mlflow.start_run(
                        ...
                        params = {
                            ...
                            "forecast_horizon_hours": int_setting("FORECAST_HORIZON_HOURS", 1),
                            "forecast_strategy": setting("FORECAST_STRATEGY"),
                            "dashboard_horizon_hours": int_setting("DASHBOARD_HORIZON_HOURS", 72),
                    ...
                    location_rows.append(
                        {
                            ...
                            "location_count": 1,
                            "target_variable": target_variable,
                            "horizon": int_setting("FORECAST_HORIZON_HOURS", 1),
                            "forecast_horizon_hours": int_setting("FORECAST_HORIZON_HOURS", 1),
                            "input_window_hours": int_setting("INPUT_WINDOW_HOURS", 168),
